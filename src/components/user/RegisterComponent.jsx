...
const RegisterFormComponent = () => {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center">
      <div className="w-fit flex flex-col items-center bg-slate-200  p-20 shadow-xl text-center mx-auto">
        {/* <LogoComponent /> */}
        <WhiteLogoComponent className={'ml-5 mt-4 w-[200px] sm:w-[120px]'} />
        <h2 className="my-4 text-black font-bold text-2xl">Usuario Nuevo</h2>
        <button
