        ...
        <div className="relative flex flex-col items-center justify-center minmd:min-w-[40vw] min-w-[100vw] h-[40vh] maxsm:h-[35vh] my-5">
          <div className="min-h-[100%] absolute z-10 max-w-full text-white flex flex-col justify-center  p-7 drop-shadow-md">
            <TextLeftMotion
              ...
              subtitle={
                "En Ofertazos MX, te ofrecemos una exquisita selección de productos de lujo de marcas renombradas como Chanel, Louis Vuitton, y Dior. Desde accesorios de moda hasta prendas icónicas, nuestro catálogo es una expresión de sofisticación y buen gusto."
              }
            />
          </div>
        </div>
