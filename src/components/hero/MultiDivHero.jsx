      ...
      <div className="min-w-full flex minmd:flex-row flex-col-reverse items-start justify-start">
        ...
        <div className="relative flex minsm:flex-row flex-col minmd:min-w-[60vw] min-w-[100vw] min-h-[30vh] ">
          <motion.div
            ...
            whileInView={{ x: 0, opacity: 1 }}
            transition={{ duration: 0.9 }}
            className="relative minmd:w-[48%] maxlg:w-[48%] maxsm:w-[100%] text-black bg-gradient-to-tr from-black to-black p-7 drop-shadow-md"
          >
            <h2 className="text-3xl maxlg:text-2xl font-black uppercase pb-3 text-white">
              Estilo y Fashion
            </h2>
      ...
      <div className="min-w-full flex minmd:flex-row flex-col-reverse items-start justify-start">
        <div className="relative flex minmd:flex-row maxlg:flex-row-reverse maxsm:flex-col min-w-[100%] ">
          <motion.div
            ...
            whileInView={{ x: 0, opacity: 1 }}
            transition={{ duration: 0.8 }}
            className=" w-[50%] maxsm:w-full flex flex-row items-center gap-5 text-black bg-gradient-to-tr from-gray-100 to-gray-300 px-7 py-4 drop-shadow-md"
          >
            <h2 className="text-3xl maxlg:text-2xl font-black uppercase pb-1 text-black">
