...
const AboutUsComponent = () => {
  return (
    <div>
      <section className="min-h-[700px] flex flex-row maxsm:flex-col justify-center items-center relative overflow-hidden">
      ...
      <section className=" text-center py-12 mb-20 mx-auto">
        <div className="container mx-auto">
          <h3 className="text-4xl maxmd:text-2xl font-semibold font-raleway text-gray-800 mb-5">
          ...
          <div className="flex maxmd:flex-col items-center justify-center gap-4 mt-5">
            <div className="w-full bg-white rounded-sm px-3 py-8 shadow-md">
              <Image
