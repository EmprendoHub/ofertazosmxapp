  ...
  return (
    <section className="container flex flex-col items-center justify-center min-h-[400px] maxsm:h-full">
      <div className="relative flex flex-row maxsm:flex-col items-center w-full bg-slate-300 h-[400px] maxsm:h-full">
        <div className="relative flex flex-row maxsm:flex-col maxsm:w-full  w-3/4 bg-gray-200 h-full">
          ...
          <div className="p-8 maxsm:p-4 maxsm:pb-0 relative flex items-center justify-center h-[400px] w-6/12 maxsm:w-full maxsm:h-full">
            <Image
              src={`/images/Coach_purser_example.webp`}
              alt="img"
              width={300}
              height={300}
      ...
      <div className="container flex flex-row maxsm:flex-col items-center w-full bg-slate-300 h-[400px] maxsm:h-full">
        <div className="w-1/4 maxsm:w-full p-4 maxsm:pb-0 relative flex flex-col items-start justify-start bg-gray-300 h-full">
          ...
          <Image
            ...
            width={250}
            height={250}
            src={`/images/Kate_spade_example.webp`}
            className="absolute maxsm:relative object-cover bottom-0"
          />
        </div>
        <div className="w-1/4 maxsm:w-full p-8 maxsm:p-4 maxsm:pb-0 relative flex flex-col items-start justify-start  bg-slate-100 h-full">
          ...
          <Image
            ...
            width={250}
            height={250}
            src={`/images/kurt_geiger_example.webp`}
            className="absolute maxsm:relative object-cover bottom-0"
          />
        </div>
        <div className="w-1/4 maxsm:w-full p-8 maxsm:p-4 maxsm:pb-0 relative flex flex-col items-start justify-end  bg-blue-200 h-full">
