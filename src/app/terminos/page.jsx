...
const TerminosPage = () => {
  ...
  <section className="hero bg-gray-100 text-center py-20">
    <div className="container mx-auto">
      <h1 className="text-4xl font-extrabold font-playfair-display text-black">Términos de servicio</h1>
      <p className="text-lg text-gray-600 mt-4">
      Este sitio web es operado por Shopout MX. En todo el sitio, los términos “nosotros”, “nos” y “nuestro” se refieren a Shopout MX. Shopout MX ofrece este sitio web, incluida toda la información, herramientas y servicios disponibles en este sitio para usted, el usuario, condicionado a la aceptación de todos los términos, condiciones, políticas y avisos aquí establecidos.
      </p>
    </div>
  </section>
      ...
      <section className="mb-4">
        <h2 className="text-2xl font-semibold">SECCIÓN 1 - TÉRMINOS DE LA TIENDA ONLINE</h2>
        <p className="mt-2">
      ...
      <section className="mb-4">
        <h2 className="text-2xl font-semibold">SECCIÓN 2 - CONDICIONES GENERALES</h2>
        <p className="mt-2">
      ...
      <section className="mb-4">
        <h2 className="text-2xl font-semibold">SECCIÓN 3 - EXACTITUD, INTEGRIDAD Y ACTUALIDAD DE LA INFORMACIÓN</h2>
        <p className="mt-2">
      ...
      <section className="mb-4">
        <h2 className="text-2xl font-semibold">SECCIÓN 4 - MODIFICACIONES AL SERVICIO Y PRECIOS</h2>
        <p className="mt-2">
      ...
      <section className="mb-4">
        <h2 className="text-2xl font-semibold">SECCIÓN 5 - PRODUCTOS O SERVICIOS (si corresponde)</h2>
        <p className="mt-2">
        Ciertos productos o servicios pueden estar disponibles exclusivamente en línea a través del sitio web. Estos productos o servicios pueden tener cantidades limitadas y están sujetos a nuestras <a href="/devoluciones">condiciones de devolución o cambio</a>.
        </p>
      ...
      <section className="mb-4">
        <h2 className="text-2xl font-semibold">SECCIÓN 6 - EXACTITUD DE LA FACTURACIÓN Y LA INFORMACIÓN DE LA CUENTA</h2>
        <p className="mt-2">
      ...
      <section className="mb-4">
        <h2 className="text-2xl font-semibold">SECCIÓN 7 - HERRAMIENTAS OPCIONALES</h2>
        <p className="mt-2">
      ...
      <section className="mb-4">
        <h2 className="text-2xl font-semibold">SECCIÓN 8 - ENLACES DE TERCEROS</h2>
        <p className="mt-2">
      ...
      <section className="mb-4">
        <h2 className="text-2xl font-semibold">SECCIÓN 9 - COMENTARIOS DE USUARIOS, RETROALIMENTACIÓN Y OTROS ENVÍOS</h2>
        <p className="mt-2">
      ...
      <section className="mb-4">
        <h2 className="text-2xl font-semibold">SECCIÓN 10 - INFORMACIÓN PERSONAL</h2>
        <p className="mt-2">
        Nuestro envío de información personal a través de la tienda se rige por nuestra Política de Privacidad. Para ver nuestra Política de Privacidad.
        </p>

      </section>

      <section className="mb-4">
        <h2 className="text-2xl font-semibold">SECCIÓN 11 - ERRORES, IMPRECISIONES Y OMISIONES</h2>
        <p className="mt-2">
      ...
      <section className="mb-4">
        <h2 className="text-2xl font-semibold">SECCIÓN 12 - USOS PROHIBIDOS</h2>
        <p className="mt-2">
      ...
      <section className="mb-4">
        <h2 className="text-2xl font-semibold">SECCIÓN 13 - RENUNCIA DE GARANTÍAS; LIMITACIÓN DE RESPONSABILIDAD</h2>
        <p className="mt-2">
      ...
      <section className="mb-4">
        ...
        <p className="mt-2">
        En el caso de que se determine que cualquier disposición de estos Términos de servicio es ilegal, nula o inaplicable, dicha disposición será, no obstante, ejecutable en la mayor medida permitida por la ley aplicable, y la parte inaplicable se considerará separada de estos Términos de servicio. Servicio, dicha determinación no afectará la validez y aplicabilidad de cualquier otra disposición restante.
        </p>
      ...
      <section className="mb-4">
        <h2 className="text-2xl font-semibold">SECCIÓN 17 - ACUERDO COMPLETO</h2>
        <p className="mt-2">
        ...
        <p className="mt-2">
        Estos Términos de servicio y cualquier política o regla operativa publicada por nosotros en este sitio o con respecto al Servicio constituyen el acuerdo completo y el entendimiento entre usted y nosotros y rigen su uso del Servicio, reemplazando cualquier acuerdo, comunicación y propuesta anterior o contemporánea. , ya sea oral o escrito, entre usted y nosotros (incluidas, entre otras, cualquier versión anterior de los Términos de servicio).
        </p>
      ...
      <section className="mb-4">
        ...
        <p className="mt-2">
        Estos Términos de Servicio y cualquier acuerdo separado mediante el cual le proporcionemos Servicios se regirán e interpretarán de acuerdo con las leyes de Sahuayo de Morelos, Michoacán, México.
        </p>
      ...
      <section className="mb-4">
        <h2 className="text-2xl font-semibold">SECCIÓN 19 - CAMBIOS A LOS TÉRMINOS DE SERVICIO</h2>
        <p className="mt-2">
      ...
      <section className="mb-4">
        <h2 className="text-2xl font-semibold">SECCIÓN 20 - INFORMACIÓN DE CONTACTO</h2>
        <p className="mt-2">
        Preguntas sobre los Términos de Servicio deben enviarnos a contacto@shopout.com.mx
        </p>
      </section>
    </div>
  </div>
